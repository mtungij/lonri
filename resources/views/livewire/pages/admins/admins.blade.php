    ...
    <div class="w-full mb-1">
        ...
        <div class="sm:flex">
            ...
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                <a   href="{{ route('usersCreate')}}"  class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                       ...
                       @foreach($admins as $admin)
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <img src="{{ asset('storage/' . $admin->img) }}" alt="Admin Image" class="w-10 h-10 rounded-full">
